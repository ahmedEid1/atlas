...
[![Tests](https://img.shields.io/badge/tests-328%20passing-success?style=flat-square)](#)
...
| **Tests** | 328 unit/integration + 3 live e2e MCP smoke checks, all green; tsc + lint clean |
...
```bash
pnpm test                                                                # 328 unit/integration tests
