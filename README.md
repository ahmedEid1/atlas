...
[![Tests](https://img.shields.io/badge/tests-391%20passing-success?style=flat-square)](#)
...
| **Tests** | 391 unit/integration + 3 live e2e MCP smoke checks, all green; tsc + lint clean |
...
pnpm test                                                                # 391 unit/integration tests on their own
