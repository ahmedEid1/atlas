...
[![Tests](https://img.shields.io/badge/tests-327%20passing-success?style=flat-square)](#)
...
| **Tests** | 327 unit/integration + 3 live e2e MCP smoke checks, all green; tsc + lint clean |
...
```bash
pnpm test                                                                # 327 unit/integration tests
